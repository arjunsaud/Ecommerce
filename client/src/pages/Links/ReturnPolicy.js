    ...
    <div className="main container">
      <div className="article" id="content">
        <div id="placeholders">
          <h2>Return Policy </h2>
          <p>
            At <span className="highlight preview_website_name">Website Name</span>,
            accessible at
            <span className="highlight preview_website_url">Website.com</span>, one
            of our main priorities is the privacy of our visitors. This Privacy
            Policy document contains types of information that is collected and
            recorded by
            <span className="highlight preview_website_name">Website Name</span> and
            how we use it.
          </p>
          <p>
          ...
          <p>
            Note that
            <span className="highlight preview_website_name">Website Name</span> has
          ...
          <p>
            <span className="highlight preview_website_name">Website Name</span>'s
